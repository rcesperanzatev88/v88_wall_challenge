 <? foreach ($data as $messages) { ?>
                <div class = "message_block" data-attr-id = <?= $messages["id"] ?>>
                    <p class = "user_name"><?= $messages["creator"] ?> <?= $messages["created_at"] ?> <?= ($this->user_login["id"] == $messages["message_user_id"] ) ? '<a href = '.base_url().'delete_message/'.$messages["id"].'>delete</a>' : '' ?></p>
...
?>
                        <div class = "comment_block">
                            ...
                            <p class = "user_name"><?= $comments->creator ?> <?= $comments->created_at ?> <?= ($this->user_login["id"] == $comments->message_user_id ) ? '<a href = '.base_url().'delete_comment/'.$comments->id.'>delete</a>' : '' ?></p>
